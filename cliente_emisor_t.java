...
public class cliente_emisor_t extends Thread {
    ...
    public cliente_emisor_t(buzon buzon_entrada, int id_cliente_emisor, int n_correos){
    ...
    private mensaje produce(){
        int msjId = 0;
        synchronized (cliente_emisor_t.class) {
